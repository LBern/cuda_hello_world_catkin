 ...
 */
#ifndef INCLUDE_CUDA_HELLO_WORLD_TEST_ENTRYPOINT_H_
#define INCLUDE_CUDA_HELLO_WORLD_TEST_ENTRYPOINT_H_
...
class UnitTestEntryPointBase {
 public:
  virtual ~UnitTestEntryPointBase() = default;
...
class UnitTestEntryPoint : public UnitTestEntryPointBase {
 public:
  virtual ~UnitTestEntryPoint() = default;
...
#define UNITTEST_ENTRYPOINT               \
  int main(int argc, char** argv) {       \
    cuda::UnitTestEntryPoint entry_point; \
    return entry_point.run(argc, argv);   \
  }

#endif  // INCLUDE_CUDA_HELLO_WORLD_TEST_ENTRYPOINT_H_
